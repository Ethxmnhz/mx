          ...
          <button
            ...
            onClick={() => {
              try {
                ...
                // Best-effort: send volume command to Dailymotion player (API must be enabled by api=1)
                // Not all embeds honor this; DM caps at 100%.
                const cmds = [
                  { command: 'unmute' },
            ...
            className="absolute top-3 right-3 z-10 px-3 py-1.5 rounded-md text-xs font-semibold border bg-white/10 text-slate-200 border-white/20 hover:bg-white/20"
