          ...
          <div className="relative p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="rounded-2xl bg-[#120F18] p-4 md:p-6">
                  <img
                    src="/icon.png"
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="rounded-xl bg-white/[0.03] p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-slate-400 text-xs">Exam Window</div>
                <div className="text-slate-100 font-semibold">24 Hours</div>
              </div>
            </div>
          </div>
          <div className="rounded-xl bg-white/[0.03] p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-slate-400 text-xs">Targets</div>
                <div className="text-slate-100 font-semibold">Linux + Windows</div>
              </div>
            </div>
          </div>
          <div className="rounded-xl bg-white/[0.03] p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-slate-400 text-xs">Submission</div>
                <div className="text-slate-100 font-semibold">Professional Report</div>
              </div>
            </div>
          </div>
          <div className="rounded-xl bg-white/[0.03] p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-slate-100 font-semibold">Verifiable Certificate</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            ...
            <div className="mt-4 text-sm text-slate-400">
              Preview of the credential awarded upon successful review.
            </div>
            <div className="mt-4">
