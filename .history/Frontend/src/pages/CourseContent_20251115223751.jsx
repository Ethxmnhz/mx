              ...
              <div className="p-6">
                {activeContent.file_type === 'video' ? (
                  <div className="space-y-3">
                    <div className="px-4 py-2 text-xs rounded-md border border-white/10 bg-black/40 text-slate-300">
                      Tip: For clearer sound and reduced background noise, use headphones.
                    </div>
