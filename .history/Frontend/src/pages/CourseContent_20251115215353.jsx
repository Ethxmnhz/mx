...
function VideoBoostButton({ isDailymotion }) {
  ...
  const handleBoost = async () => {
    try {
      ...
      // Get the video element with data attribute
      const videoEl = document.querySelector('video[data-video-player="true"]');
      
      if (!videoEl) {
        console.error('✗ Video element not found - looking for video[data-video-player="true"]');
