...
export default function Landing() {
  ...
  {/* Highlights */}
        ...
        <section id="programs" className="mx-auto max-w-6xl px-6 py-14">
          ...
          <p className="text-slate-400 text-sm mb-8">Learn practical cybersecurity skills with hands-on labs, videos, and expert mentorship. Get certified with verifiable credentials.</p>
          
          <div className="space-y-6">
            {/* MJPT - Course + Certification */}
            <div className="rounded-2xl bg-[#120F18] border border-white/10 p-8">
              <div className="flex items-start justify-between gap-6">
                <div className="flex-1">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-400/30 text-emerald-200 text-xs font-semibold w-max mb-4">
                    <AcademicCapIcon className="h-4 w-4" /> MJPT Program
                  </div>
                  
                  <h3 className="text-2xl font-bold text-slate-100 mb-3">MaxSec Junior Penetration Tester</h3>
                  
                  <p className="text-slate-300 mb-4"><strong>Enroll in our comprehensive MJPT course</strong> featuring video tutorials, detailed presentations, and hands-on labs on Linux & Windows environments.</p>
                  
                  <div className="bg-emerald-500/10 border border-emerald-400/30 rounded-lg p-4 mb-6">
                    <div className="text-emerald-300 font-semibold text-sm mb-2">✨ Special Offer</div>
                    <div className="text-slate-300 text-sm">Get a <strong>FREE MJPT Exam Voucher</strong> when you enroll</div>
                    <div className="text-emerald-300 text-sm font-semibold mt-1">🔥 90% OFF for first 100 users</div>
                  </div>
                  
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      <div className="text-emerald-400 text-xl mb-2">📚</div>
                      <div className="text-slate-100 font-semibold text-sm">Comprehensive Course</div>
                      <div className="text-slate-400 text-xs mt-1">Videos, PPTs & labs</div>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      <div className="text-emerald-400 text-xl mb-2">🎯</div>
                      <div className="text-slate-100 font-semibold text-sm">Free Exam</div>
                      <div className="text-slate-400 text-xs mt-1">24-hour assessment</div>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      <div className="text-emerald-400 text-xl mb-2">🏆</div>
                      <div className="text-slate-100 font-semibold text-sm">Certificate</div>
                      <div className="text-slate-400 text-xs mt-1">Verifiable credential</div>
                    </div>
                  </div>
                  
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link to="/signup" className="px-6 py-2 rounded-md bg-emerald-500/20 text-emerald-100 border border-emerald-400/30 hover:bg-emerald-500/30 text-sm font-semibold text-center">Enroll Now</Link>
                    <Link to="/mjpt" className="px-6 py-2 rounded-md bg-white/5 text-slate-200 border border-white/10 hover:bg-white/10 text-sm font-semibold text-center">Exam Details</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-[#100B15] border border-white/10 p-8">
              <div className="flex items-start justify-between gap-6">
                <div className="flex-1">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-400/30 text-emerald-200 text-xs font-semibold w-max mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-slate-100 mb-3">Corporate & Enterprise Training</h3>
                  
                  <p className="text-slate-300 mb-4"><strong>Tailored cybersecurity programs for teams and organizations.</strong> We design custom curricula mapped to your specific security challenges and skill gaps.</p>
                  
                  <div className="bg-emerald-500/10 border border-emerald-400/30 rounded-lg p-4 mb-6">
                    <div className="text-emerald-300 font-semibold text-sm mb-2">🏢 For Organizations</div>
                    <div className="text-slate-300 text-sm">Flexible delivery, proven results, and verifiable outcomes</div>
                  </div>
                  
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      <div className="text-emerald-400 text-xl mb-2">🎯</div>
                      <div className="text-slate-100 font-semibold text-sm">Custom Design</div>
                      <div className="text-slate-400 text-xs mt-1">Role-based paths</div>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      <div className="text-emerald-400 text-xl mb-2">📍</div>
                      <div className="text-slate-100 font-semibold text-sm">Flexible Delivery</div>
                      <div className="text-slate-400 text-xs mt-1">Onsite or remote</div>
                    </div>
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                      <div className="text-emerald-400 text-xl mb-2">💪</div>
                      <div className="text-slate-100 font-semibold text-sm">Hands-On Labs</div>
                      <div className="text-slate-400 text-xs mt-1">Real assessments</div>
                    </div>
                  </div>
                  
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Link to="/contact" className="px-6 py-2 rounded-md bg-emerald-500/20 text-emerald-100 border border-emerald-400/30 hover:bg-emerald-500/30 text-sm font-semibold text-center">Contact Sales</Link>
                    <Link to="/about" className="px-6 py-2 rounded-md bg-white/5 text-slate-200 border border-white/10 hover:bg-white/10 text-sm font-semibold text-center">Learn More</Link>
                  </div>
                </div>
              </div>
            </div>
