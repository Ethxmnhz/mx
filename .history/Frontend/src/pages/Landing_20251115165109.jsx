              ...
              <div className="grid md:grid-cols-2 gap-6 items-start min-h-[400px]">
                <div>
                  ...
                  <div className="flex gap-3">
                    <Link to="/signup" className="flex-1 px-3 py-2 rounded-md bg-emerald-500/20 text-emerald-100 border border-emerald-400/30 hover:bg-emerald-500/30 text-sm font-semibold text-center">Enroll Now</Link>
                    <Link to="/mjpt" className="flex-1 px-3 py-2 rounded-md bg-white/5 text-slate-200 border border-white/10 hover:bg-white/10 text-sm font-semibold text-center">Exam Details</Link>
                  </div>
                </div>
                <div className="relative flex items-center justify-center">
                  ...
                  <img src="/icon.png" alt="MJPT Icon" className="w-full max-h-[320px] object-contain" onError={(e)=>{e.currentTarget.onerror=null; e.currentTarget.src='/logo.png'}} />
                </div>
              </div>
            </div>
