            ...
            <div className="rounded-2xl bg-[#120F18] p-6 md:p-8">
              <div className="grid md:grid-cols-2 gap-6 items-center min-h-[340px]">
                <div>
                  ...
                  <h3 className="mt-3 text-2xl font-bold">MaxSec Junior Penetration Tester</h3>
                  <p className="mt-2 text-slate-300 text-sm"><strong>Enroll in our comprehensive MJPT course</strong> featuring video tutorials, detailed presentations, and hands-on labs on Linux & Windows environments.</p>
                  <div className="mt-4 bg-emerald-500/10 border border-emerald-400/30 rounded-lg p-3 mb-3">
                  ...
                  <ul className="mt-3 text-slate-300 text-sm space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span><strong>Course:</strong> Videos, PPTs, and lab exercises</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-400 mt-1">🎯</span>
                      <span><strong>Free Exam:</strong> 24-hour practical assessment</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-400 mt-1">🏆</span>
                      <span><strong>Certificate:</strong> Verifiable industry credential</span>
                    </li>
                  </ul>
                  <div className="mt-5 flex gap-3">
                    <Link to="/signup" className="px-4 py-2 rounded-md bg-emerald-500/20 text-emerald-100 border border-emerald-400/30 hover:bg-emerald-500/30 text-sm font-semibold">Enroll Now</Link>
                    <Link to="/mjpt" className="px-4 py-2 rounded-md bg-white/5 text-slate-200 border border-white/10 hover:bg-white/10 text-sm font-semibold">Exam Details</Link>
                  </div>
                </div>
            ...
            <div className="rounded-2xl bg-[#100B15] p-6 md:p-8">
              <div className="grid md:grid-cols-2 gap-6 items-center min-h-[340px]">
                <div>
                  ...
                  <h3 className="mt-3 text-2xl font-bold">Corporate & Enterprise Training</h3>
                  <p className="mt-2 text-slate-300 text-sm"><strong>Tailored cybersecurity programs for teams and organizations.</strong> We design custom curricula mapped to your specific security challenges and skill gaps.</p>
                  <div className="mt-4 bg-emerald-500/10 border border-emerald-400/30 rounded-lg p-3 mb-3">
